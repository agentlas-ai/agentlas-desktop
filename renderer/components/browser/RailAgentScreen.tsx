  ...
  return (
    <section className="rail-agent-screen" data-rail-agent-screen="true" aria-label={ko ? "에이전트가 보는 화면" : "Screen visible to the agent"}>
      ...
      <style jsx>{`
        ...
        .modes button.selected { background: var(--ink); color: var(--paper); }
      ...
      <style jsx global>{`
        .rail-agent-screen .cua-canvas { flex: 1; min-height: 0; width: 100%; display: grid; place-items: center; overflow: hidden; border: 0; padding: 0; background: #111416; cursor: pointer; }
        ...
        .rail-agent-screen .cua-live-dot { width: 7px; height: 7px; border-radius: 50%; background: #b68a35; flex-shrink: 0; }
        .rail-agent-screen .cua-live-dot.ready { background: #2aa978; box-shadow: 0 0 0 3px rgba(42,169,120,0.13); }
        .rail-agent-screen .cua-empty { display: flex; flex-direction: column; align-items: center; gap: 5px; color: rgba(255,255,255,0.82); text-align: center; padding: 12px; }
        ...
        .rail-agent-screen .cua-empty-screen { width: 28px; height: 19px; border: 1.5px solid rgba(255,255,255,0.45); border-radius: 4px; position: relative; margin-bottom: 3px; }
        .rail-agent-screen .cua-empty-screen::after { content: ""; position: absolute; left: 9px; right: 9px; bottom: -5px; height: 1.5px; background: rgba(255,255,255,0.45); }
        ...
        .rail-agent-screen footer .warn { color: #a77721; font-weight: 700; }
