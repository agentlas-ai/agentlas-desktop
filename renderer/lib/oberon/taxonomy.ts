...
export const GENRE_TEMPLATES: Record<FilmFormat, GenreTemplate> = {
  ...
  motion_graphics_30: {
    ...
    sequenceTarget: 1,
    beats: [
      { name: "문제 훅", nameEn: "Chaos Hook", emotion: "정리 욕구", weight: 0.18, sceneType: "transition" },
      { name: "시스템 등장", nameEn: "System Reveal", emotion: "명료함", weight: 0.24, sceneType: "product" },
      { name: "제품 증거", nameEn: "Product Proof", emotion: "신뢰", weight: 0.28, sceneType: "montage" },
      { name: "출력 패키지", nameEn: "Export Package", emotion: "실행감", weight: 0.16, sceneType: "product" },
      { name: "CTA", nameEn: "CTA", emotion: "결정", weight: 0.14, sceneType: "transition" },
    ],
  },
  motion_graphics_60: {
    ...
    sequenceTarget: 2,
    beats: [
      { name: "문제", nameEn: "Problem", emotion: "혼잡", weight: 0.16, sceneType: "transition" },
      { name: "워크플로", nameEn: "Workflow", emotion: "정돈", weight: 0.2, sceneType: "product" },
      { name: "기능 증거", nameEn: "Capabilities", emotion: "발견", weight: 0.22, sceneType: "montage" },
      { name: "품질 증거", nameEn: "Proof", emotion: "확신", weight: 0.18, sceneType: "product" },
      { name: "납품", nameEn: "Delivery", emotion: "완료", weight: 0.14, sceneType: "montage" },
      { name: "CTA", nameEn: "CTA", emotion: "결정", weight: 0.1, sceneType: "transition" },
    ],
  },
  trailer: {
    format: "trailer",
