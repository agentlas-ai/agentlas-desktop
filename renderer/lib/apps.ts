...
export const INSTALLED_APPS: AgentlasAppDefinition[] = [
  ...
  },
  {
    ...
    tagline: "영화·애니메이션·모션그래픽을 기획→레퍼런스→생성→QA→납품 한 흐름으로 묶는 AI 제작 스튜디오",
    taglineEn: "An AI production studio for film, animation, and motion graphics: brief → references → generation → QA → delivery",
    kind: "ai-native",
    route: "/oberon",
    accent: "var(--accent)",
    engines: ["Showrunner", "Shot Planner", "Continuity Bible", "Image-to-video", "Motion renderer", "Delivery QA"],
    vaultKeys: ["GEMINI_API_KEY", "RUNWAY_API_KEY", "LUMA_API_KEY", "OPENAI_API_KEY", "FIREFLY_API_KEY"],
    artifacts: ["Shot list", "Prompt pack", "Continuity bible", "Generated takes", "Motion renders", "Delivery masters"],
  ...
  },
  {
    ...
    slug: "site",
    name: "사이트 디자인 스튜디오",
    nameEn: "Site Design Studio",
    tagline: "웹앱디자인마스터가 화면 디자인을 통째로 뽑고, 캔버스에서 요소를 클릭해 바로 고친다. 디자인 전용 — 서버·빌드 없음.",
    taglineEn: "The design master ships whole screens; click any element on the canvas to refine it. Design-only — no servers, no builds.",
    kind: "ai-native",
    route: "/site",
    accent: "var(--accent)",
    engines: ["웹앱디자인마스터", "Offset tagger", "Sandbox canvas", "Select-to-edit"],
    vaultKeys: [],
    artifacts: ["Self-contained HTML screens", "Project ZIP"],
    slashCommands: ["/site", "/사이트", "/webdesign"],
  },
  {
    id: "document-studio",
