...
const dict = {
  ko: {
    ...
    "sidebar.apps_vault": "Apps Vault",
    "sidebar.apps_engines": "Apps Engines",
    "sidebar.agents": "에이전트",
    ...
    "onb.tour.library.desc": "설치된 Apps, Apps Store, 자격증명 Vault, 외부 엔진(MCP)을 한 곳에서 관리합니다.",
  ...
  en: {
    ...
    "onb.tour.library.title": "Apps",
    "onb.tour.library.desc": "Manage installed Apps, Apps Store, credential vault, and external engines (MCP) in one place.",
