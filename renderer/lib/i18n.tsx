...
const dict = {
  ko: {
    ...
    "auto.detail.runtime_note": "예약 시간이 되면 백그라운드에서 이 프롬프트를 다시 실행합니다. 비활성화하면 다음 실행부터 멈춥니다.",
    // 자동화 플로우 뷰어(그래프)
    "auto.flow.view": "플로우 보기",
    "auto.flow.run_now": "지금 실행",
    "auto.flow.running": "실행 중…",
    "auto.flow.activate": "활성화",
  ...
  en: {
    ...
    "auto.detail.runtime_note": "This automation reruns this prompt in the background when due. Disable it to stop the next run.",
    // Automation flow viewer (graph)
    "auto.flow.view": "View flow",
    "auto.flow.run_now": "Run now",
    "auto.flow.running": "Running…",
    "auto.flow.activate": "Activate",
