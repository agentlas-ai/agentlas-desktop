...
const dict = {
  ko: {
    ...
    "sidebar.startup": "Startup 파운더 스튜디오",
    "sidebar.startup_hint": "아이디어→검증→사업계획→PRD→빌드",
    "sidebar.agents": "에이전트",
  ...
  en: {
    ...
    "sidebar.startup": "Startup Founder Studio",
    "sidebar.startup_hint": "Idea → validation → business plan → PRD → build",
