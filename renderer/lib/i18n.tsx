...
const dict = {
  ko: {
    ...
    "chatinput.cmd.help_text": "단축키 — Enter: 전송 · Shift+Enter: 줄바꿈 · / : 커맨드(/new, /apps, /document-studio, /문서스튜디오, /clear, /help) · @ : 에이전트·프로젝트·회사·환경변수 멘션 · ⌘[ : 사이드바 접기",
  ...
  en: {
    ...
    "chatinput.cmd.help_text": "Shortcuts — Enter: send · Shift+Enter: newline · / : commands (/new, /apps, /document-studio, /docstudio, /clear, /help) · @ : mention agents, projects, firms, env · ⌘[ : toggle sidebar",
