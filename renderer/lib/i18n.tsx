...
const dict = {
  ko: {
    ...
    "sidebar.tools": "생성 도구",
    "sidebar.mcps": "외부 도구",
    "sidebar.marketplace": "Apps Store",
    "sidebar.settings": "설정",
    "sidebar.archive": "보관함",
    ...
    "onb.tour.library.desc": "설치된 Apps, Apps Store, 전역 Env, Plugins(MCP)를 한 곳에서 관리합니다.",
    ...
    "onb.done.desc": "다음 화면에서 Apps Store를 열고 첫 App을 설치하세요.",
    ...
    "market.btn.manage": "설치된 Apps",
    "market.btn.create": "App 만들기",
    ...
    "chatinput.placeholder_disabled": "설치된 App이 없습니다 — Apps Store에서 설치하세요",
    ...
    "chatinput.apps_generate_mode": "Apps Generate",
    "chatinput.apps_generate_hint": "채팅 목표를 Agentlas 안에서 실행되는 앱으로 만들기",
    "chatinput.model": "모델",
    ...
    // Library
    "library.agents.subtitle": "Agentlas 안에서 열리고, 어떤 AI 대화에서도 호출할 수 있는 설치된 Apps입니다.",
    "library.agents.add": "Apps Store",
    ...
    "library.agents.empty": "아직 설치된 App이 없습니다.",
  ...
  en: {
    ...
    "onb.tour.library.title": "Apps",
    "onb.tour.library.desc": "Manage installed Apps, Apps Store, Global Env, and Plugins (MCP) in one place.",
    ...
    "onb.done.desc": "Open the Apps Store on the next screen and install your first App.",
    ...
    "market.btn.manage": "Installed Apps",
    "market.btn.create": "Create App",
    ...
    "chatinput.placeholder_disabled": "No App installed — go to Apps Store",
    ...
    "chatinput.apps_generate_mode": "Apps Generate",
    "chatinput.apps_generate_hint": "Turn this chat goal into an app that runs inside Agentlas",
    ...
    "auto.empty_firms": "No firm installed. Install one from Apps Store → Firms.",
    ...
    // Library
    "library.agents.subtitle": "Installed Apps that open inside Agentlas and can be called from any AI chat.",
    "library.agents.add": "Apps Store",
    ...
    "library.agents.empty": "No App installed yet.",
