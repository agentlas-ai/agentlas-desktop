...
const dict = {
  ko: {
    ...
    "auto.title": "자동화",
    "auto.new": "새 자동화",
    "auto.runtime_note": "자동화는 예약 시간이 되면 백그라운드에서 프롬프트를 다시 실행합니다. 외부 계정 작업은 커넥터나 브라우저 실행 증거가 있을 때만 완료로 봅니다.",
  ...
  en: {
    ...
    "auto.runtime_note": "Automations rerun the prompt in the background when due. External account work only counts as done when a connector or browser run proves it.",
