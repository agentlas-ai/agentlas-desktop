...
- **2026-09-18 · v1.2.22 — 장기 작업과 겹치는 예약 실행을 이어갑니다** — Antigravity 시간 조회와 네이티브 브라우저의 실제 완료 기록을 대기·재개에 연결하고, 실행 ID가 비밀키로 오인돼 손상되지 않도록 합니다. 자동 보고서는 원래 One·Work 대화에 새로고침 없이 표시되며, 앱이 예약한 독립 작업은 다른 실행의 도구 설정이 해제될 때까지 자신의 제한 시간 안에서 기다립니다. 미공개 1.2.20·1.2.21의 수정도 포함합니다. Source readiness does not prove a public installer or update feed; the Releases page stays the authority. This release binds Agentlas OS v1.2.44 at 1f6d64374502cfd5f8581ad3c1fb18691ed61b1d. Its public runtime asset `hephaestus-runtime-v1.2.44.tar.gz` is pinned at SHA-256 `795d1c294db662475d4eb0c7e4562ba0ca1e0f27d3b1da0f5e9c6e7cf627d83a`.
