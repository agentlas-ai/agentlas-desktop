...
- **2026-08-23 · v1.0.34 — Cloud publish receipts tell the truth** — Bundled runtime: Agentlas OS v1.2.16 (6d0d7e7eafaa96ebbed92e1a2223b01f13eed245). A live publish is no longer shown as a failed upload, and server-withheld package files are named in the result. Source readiness does not prove a public installer; the Releases page stays the authority.
