...
- **2026-09-13 · v1.2.3 — 로컬 비전 모델을 멀티모달로 등록하고, Science 원고가 학회 논문 모양으로 조판됩니다** — 비전 프로젝터(mmproj)가 있는 로컬 모델은 함께 설치·로드되어 이미지 입력을 받고 대시보드 멀티모달 자리에 올 수 있습니다. 로컬 모델 탐색은 필터 있는 표로. Science 원고 기본 조판은 두 단 10pt 절 위계. Bundled runtime: Agentlas OS v1.2.44 (1f6d64374502cfd5f8581ad3c1fb18691ed61b1d)
