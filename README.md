...
- **2026-09-18 · v1.2.23 — 장기 작업·채팅·예약 실행의 연결 경합을 처리합니다** — Antigravity 시간 조회와 네이티브 브라우저의 실제 완료 기록을 대기·재개에 연결하고, 실행 ID가 비밀키로 오인돼 손상되지 않도록 합니다. 자동 보고서는 원래 One·Work 대화에 새로고침 없이 표시됩니다. 독립 예약 작업뿐 아니라 허용된 새 채팅과 목표 재개도 선택한 실행 연결이 해제될 때까지 기다리며, 대기는 취소할 수 있습니다. 미공개 1.2.20–1.2.22의 수정도 포함합니다. Source readiness does not prove a public installer or update feed; the Releases page stays the authority. This release binds Agentlas OS v1.2.44 at 1f6d64374502cfd5f8581ad3c1fb18691ed61b1d. Its public runtime asset `hephaestus-runtime-v1.2.44.tar.gz` is pinned at SHA-256 `795d1c294db662475d4eb0c7e4562ba0ca1e0f27d3b1da0f5e9c6e7cf627d83a`.
