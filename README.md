...
- **2026-09-19 · v1.2.30 — 장기 Goal의 브라우저 실행 종료와 스티어링 표시 수정** — Full Access 브라우저 코드 실행은 Main이 실제 Playwright 콜백 종료와 미결 콜백·모달·취소·도구 오류 없음을 확인한 경우 장기 Goal을 이어갑니다. 사용자의 새 메시지로 실행이 교체된 경우에는 실패가 아니라 방향 수정으로 표시합니다. 1.2.29의 재시작 체크포인트, 실행 폴더 고정, 중복 결과 방지와 검증 필터 수정도 포함합니다. Source readiness does not prove a public installer or update feed; the Releases page stays the authority. This release binds Agentlas OS v1.2.44 at 1f6d64374502cfd5f8581ad3c1fb18691ed61b1d. Its public runtime asset `hephaestus-runtime-v1.2.44.tar.gz` is pinned at SHA-256 `795d1c294db662475d4eb0c7e4562ba0ca1e0f27d3b1da0f5e9c6e7cf627d83a`.
