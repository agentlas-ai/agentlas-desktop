...
export const PACKAGE_MAX_TOTAL_BYTES = 31457280;
export const PACKAGE_MAX_FILE_BYTES = 6291456;
export const PACKAGE_MAX_UNCOMPRESSED_TOTAL_BYTES = 125829120;
export const PACKAGE_MAX_UNCOMPRESSED_FILE_BYTES = 25165824;
export const PACKAGE_MAX_FILES = 400;
export const PACKAGE_MAX_REQUEST_BYTES = 47185920;
