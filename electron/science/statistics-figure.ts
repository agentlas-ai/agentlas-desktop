...
export const STATISTICS_FIGURE_CATALOG_VERSION = "2.0.0" as const;
...
// Role to publication-template bindings. Entries after the hand-authored block are generated from
// the visualization roles the extension method registry actually emits; the matching catalog rows
// come from the same run (scripts/science-statistics-figure-catalog.cjs), so a role and its
// template share one identity. The coverage contract parses this object statically, so it must
// contain nothing but "role": "template" lines.
const STATISTICS_TEMPLATE_BY_ROLE: Readonly<Record<string, string>> = Object.freeze({
  "asset-pricing-characteristic-line": "asset-pricing-characteristic-line",
  "asset-pricing-coefficient-forest": "asset-pricing-coefficient-forest",
  "fama-macbeth-coefficient-series": "fama-macbeth-coefficient-series",
  "fama-macbeth-premium-forest": "fama-macbeth-premium-forest",
  "grs-alpha-forest": "grs-alpha-forest",
  "grs-realised-versus-predicted": "grs-realised-versus-predicted",
  "diagnostic-accuracy-forest": "diagnostic-accuracy-forest",
  "fine-gray-subdistribution-hazard-plot": "fine-gray-subdistribution-hazard-plot",
  "gee-coefficients-plot": "gee-coefficients-plot",
  "gee-structure-plot": "gee-structure-plot",
  "glmm-fixed-effects-plot": "glmm-fixed-effects-plot",
  "glmm-quadrature-plot": "glmm-quadrature-plot",
  "lmm-slopes-fixed-effects-plot": "lmm-slopes-fixed-effects-plot",
  "lmm-slopes-group-effects-plot": "lmm-slopes-group-effects-plot",
  "missing-data-ipw-coefficient-plot": "missing-data-ipw-coefficient-plot",
  "missing-data-mi-pooled-plot": "missing-data-mi-pooled-plot",
  "missing-data-pattern-plot": "missing-data-pattern-plot",
  "missing-data-percent-missing-plot": "missing-data-percent-missing-plot",
  "roc-curve-comparison-plot": "roc-curve-comparison-plot",
  ...
  "adf-regression-figure": "adf-regression-figure",
  "adjusted-means-plot": "adjusted-means-plot",
  "aft-time-ratio-forest": "aft-time-ratio-forest",
  "agreement-fleiss-plot": "agreement-fleiss-plot",
  "agreement-heatmap": "agreement-heatmap",
  "agreement-kendall-w-plot": "agreement-kendall-w-plot",
  "agreement-krippendorff-heatmap": "agreement-krippendorff-heatmap",
  "arima-forecast-figure": "arima-forecast-figure",
  "arima-residual-acf-figure": "arima-residual-acf-figure",
  "arm-effect-forest": "arm-effect-forest",
  "auto-arima-forecast-figure": "auto-arima-forecast-figure",
  "auto-arima-residual-acf-figure": "auto-arima-residual-acf-figure",
  "bayes-ab-posterior": "bayes-ab-posterior",
  "bayes-anova-robustness": "bayes-anova-robustness",
  "bayes-correlation-posterior": "bayes-correlation-posterior",
  "bayes-meta-forest": "bayes-meta-forest",
  "bayes-proportion-posterior": "bayes-proportion-posterior",
  "bayes-regression-coefficients": "bayes-regression-coefficients",
  "bayes-t-posterior": "bayes-t-posterior",
  "binomial-pmf-plot": "binomial-pmf-plot",
  "bland-altman-plot": "bland-altman-plot",
  "bootstrap-histogram": "bootstrap-histogram",
  "capability-histogram": "capability-histogram",
  "cca-variate-plot": "cca-variate-plot",
  "change-point-figure": "change-point-figure",
  "chi-square-gof-plot": "chi-square-gof-plot",
  "cluster-validation-silhouette-plot": "cluster-validation-silhouette-plot",
  "cochran-q-proportion-plot": "cochran-q-proportion-plot",
  "conover-pairwise-heatmap": "conover-pairwise-heatmap",
  "control-chart": "control-chart",
  "control-chart-dispersion": "control-chart-dispersion",
  "cox-schoenfeld-residual-plot": "cox-schoenfeld-residual-plot",
  "cross-correlation-figure": "cross-correlation-figure",
  "cumulative-forest": "cumulative-forest",
  "cumulative-hazard-curve": "cumulative-hazard-curve",
  "cumulative-incidence-stacked": "cumulative-incidence-stacked",
  "cusum-chart": "cusum-chart",
  "cv-fold-rmse": "cv-fold-rmse",
  "dbscan-cluster-scatter": "dbscan-cluster-scatter",
  "dbscan-kdistance-plot": "dbscan-kdistance-plot",
  "decomposition-figure": "decomposition-figure",
  "did-event-study-plot": "did-event-study-plot",
  "did-trajectory-plot": "did-trajectory-plot",
  "distribution-fit-density-plot": "distribution-fit-density-plot",
  "distribution-fit-qq-plot": "distribution-fit-qq-plot",
  "dunn-pairwise-heatmap": "dunn-pairwise-heatmap",
  "ecdf-comparison": "ecdf-comparison",
  "ecdf-step-plot": "ecdf-step-plot",
  "efa-loading-heatmap": "efa-loading-heatmap",
  "efa-scree-parallel": "efa-scree-parallel",
  "effect-conversion-chart": "effect-conversion-chart",
  "effect-size-forest": "effect-size-forest",
  "elastic-net-coefficient-path": "elastic-net-coefficient-path",
  "elastic-net-cv-curve": "elastic-net-cv-curve",
  "equivalence-interval-plot": "equivalence-interval-plot",
  "ets-forecast-figure": "ets-forecast-figure",
  "ets-residual-acf-figure": "ets-residual-acf-figure",
  "evt-mean-excess-plot": "evt-mean-excess-plot",
  "evt-return-level-plot": "evt-return-level-plot",
  "ewma-chart": "ewma-chart",
  "exact-table-heatmap": "exact-table-heatmap",
  "g-test-contribution-heatmap": "g-test-contribution-heatmap",
  "gage-rr-components-of-variation": "gage-rr-components-of-variation",
  "gage-rr-interaction-plot": "gage-rr-interaction-plot",
  "gmm-assignment-scatter": "gmm-assignment-scatter",
  "gmm-bic-plot": "gmm-bic-plot",
  "granger-causality-figure": "granger-causality-figure",
  "group-dispersion-plot": "group-dispersion-plot",
  "hclust-dendrogram": "hclust-dendrogram",
  "hclust-silhouette-plot": "hclust-silhouette-plot",
  "histogram": "histogram",
  "hksj-forest": "hksj-forest",
  "hotelling-difference-plot": "hotelling-difference-plot",
  "iv-vs-ols-forest": "iv-vs-ols-forest",
  "jackknife-influence": "jackknife-influence",
  "kde-density-plot": "kde-density-plot",
  "kmeans-cluster-scatter": "kmeans-cluster-scatter",
  "kmeans-elbow-plot": "kmeans-elbow-plot",
  "kmeans-silhouette-plot": "kmeans-silhouette-plot",
  "kpss-partial-sum-figure": "kpss-partial-sum-figure",
  "landmark-km-curves": "landmark-km-curves",
  "lasso-coefficient-path": "lasso-coefficient-path",
  "lasso-cv-curve": "lasso-cv-curve",
  "lda-territorial-plot": "lda-territorial-plot",
  "location-estimate-interval": "location-estimate-interval",
  "loglinear-residual-plot": "loglinear-residual-plot",
  "mahalanobis-distance-plot": "mahalanobis-distance-plot",
  "manova-canonical-plot": "manova-canonical-plot",
  "mantel-haenszel-forest": "mantel-haenszel-forest",
  "mcnemar-discordant-plot": "mcnemar-discordant-plot",
  "mds-configuration-plot": "mds-configuration-plot",
  "mds-shepard-plot": "mds-shepard-plot",
  "median-split-bars": "median-split-bars",
  "mediation-bootstrap-plot": "mediation-bootstrap-plot",
  "meta-regression-bubble": "meta-regression-bubble",
  "model-comparison-weights": "model-comparison-weights",
  "mosaic-residual-plot": "mosaic-residual-plot",
  "multinomial-rrr-forest": "multinomial-rrr-forest",
  "negative-binomial-irr-forest": "negative-binomial-irr-forest",
  "nemenyi-pairwise-heatmap": "nemenyi-pairwise-heatmap",
  "network-geometry": "network-geometry",
  "nls-fit-plot": "nls-fit-plot",
  "non-inferiority-interval-plot": "non-inferiority-interval-plot",
  "ordered-group-trend": "ordered-group-trend",
  "ordinal-odds-ratio-forest": "ordinal-odds-ratio-forest",
  "page-rank-trend": "page-rank-trend",
  "pairwise-difference-forest": "pairwise-difference-forest",
  "partial-correlation-heatmap": "partial-correlation-heatmap",
  "permutation-histogram": "permutation-histogram",
  "phillips-perron-regression-figure": "phillips-perron-regression-figure",
  "poisson-rate-plot": "poisson-rate-plot",
  "polynomial-fit-plot": "polynomial-fit-plot",
  "power-curve": "power-curve",
  "precision-curve": "precision-curve",
  "probability-density-plot": "probability-density-plot",
  "ps-love-plot": "ps-love-plot",
  "ps-overlap-plot": "ps-overlap-plot",
  "qq-plot": "qq-plot",
  "quantile-coefficient-process": "quantile-coefficient-process",
  "rd-plot": "rd-plot",
  "rd-sensitivity-plot": "rd-sensitivity-plot",
  "relative-effect-interval": "relative-effect-interval",
  "reliability-alpha-if-deleted-plot": "reliability-alpha-if-deleted-plot",
  "reliability-icc-plot": "reliability-icc-plot",
  "reliability-omega-loading-plot": "reliability-omega-loading-plot",
  "residual-lag-plot": "residual-lag-plot",
  "residual-vs-fitted": "residual-vs-fitted",
  "ridge-coefficient-path": "ridge-coefficient-path",
  "rmst-area-curves": "rmst-area-curves",
  "robust-vs-ols-forest": "robust-vs-ols-forest",
  "robust-weight-plot": "robust-weight-plot",
  "runs-sequence-plot": "runs-sequence-plot",
  "sign-count-bars": "sign-count-bars",
  "spectrum-figure": "spectrum-figure",
  "subgroup-forest": "subgroup-forest",
  "trend-proportion-plot": "trend-proportion-plot",
  "trim-fill-funnel": "trim-fill-funnel",
  "two-by-two-risk-plot": "two-by-two-risk-plot",
  "var-impulse-response-figure": "var-impulse-response-figure",
  "vif-bar": "vif-bar",
  "weighted-log-rank-km-curves": "weighted-log-rank-km-curves",
  "weighted-rank-sums": "weighted-rank-sums",
  "within-subject-profile": "within-subject-profile",
});
