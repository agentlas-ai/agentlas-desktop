...
const ONE_COPY = {
  ko: {
    ...
    "one.mob.hubDerivativeBody": "원본 파일을 복사하지 않는 공개용 검토 초안만 준비합니다. 권리와 게시 자격을 확인한 뒤 무료로 공유할 수 있습니다.",
  ...
  en: {
    ...
    "one.mob.hubDerivativeBody": "Prepare a public review draft without copying source files. Check rights and publishing eligibility before sharing it for free.",
