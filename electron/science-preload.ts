...
contextBridge.exposeInMainWorld("agentlasScience", Object.freeze({
  ...
  projects: Object.freeze({
    ...
    bindFolder: (input: unknown) => ipcRenderer.invoke("science:projects:bindFolder", { extensionId, input }),
  ...
  journals: Object.freeze({
    ...
    useNeutralProfile: (input: unknown) => ipcRenderer.invoke("science:journals:useNeutralProfile", { extensionId, input }),
