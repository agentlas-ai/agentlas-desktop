...
// 표시 문구는 shared/schedule-describe.ts(순수, croner 비의존)로 분리해 렌더러와 공유한다.
// 기존 import 경로를 유지하기 위해 여기서 그대로 재수출한다.
export { describeSchedule } from "../../shared/schedule-describe";
