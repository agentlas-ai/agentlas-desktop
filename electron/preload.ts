...
const api: AgentlasIpc = {
  ...
  agentMail: {
    ...
    suggestAddresses: (name) => ipcRenderer.invoke("agentMail:suggestAddresses", name),
    contacts: (input) => ipcRenderer.invoke("agentMail:contacts", input ?? {}),
    contact: (id) => ipcRenderer.invoke("agentMail:contact", id),
    saveContact: (input) => ipcRenderer.invoke("agentMail:saveContact", input ?? {}),
    removeContact: (id) => ipcRenderer.invoke("agentMail:removeContact", id),
    directoryMe: () => ipcRenderer.invoke("agentMail:directoryMe"),
    saveDirectoryMe: (input) => ipcRenderer.invoke("agentMail:saveDirectoryMe", input ?? {}),
    directorySearch: (input) => ipcRenderer.invoke("agentMail:directorySearch", input ?? {}),
    directoryLookup: (address) => ipcRenderer.invoke("agentMail:directoryLookup", address),
    domains: () => ipcRenderer.invoke("agentMail:domains"),
    addDomain: (domain) => ipcRenderer.invoke("agentMail:addDomain", domain),
    domain: (input) => ipcRenderer.invoke("agentMail:domain", input ?? {}),
    restartDomain: (id) => ipcRenderer.invoke("agentMail:restartDomain", id),
    setDomainAddress: (input) => ipcRenderer.invoke("agentMail:setDomainAddress", input ?? {}),
    removeDomain: (id) => ipcRenderer.invoke("agentMail:removeDomain", id),
