...
const api: AgentlasIpc = {
  ...
  oneOnboarding: {
    getState: () => ipcRenderer.invoke("oneOnboarding:getState"),
    update: (input) => ipcRenderer.invoke("oneOnboarding:update", input),
    verifyProvider: (input) => ipcRenderer.invoke("oneOnboarding:verifyProvider", input),
    ...
    complete: (input) => ipcRenderer.invoke("oneOnboarding:complete", input),
  },
  oneActivation: {
