...
const api: AgentlasIpc = {
  ...
  appFactory: {
    ...
    startLocalApp: (input) => ipcRenderer.invoke("appFactory:startLocalApp", input),
    stopLocalApp: (input) => ipcRenderer.invoke("appFactory:stopLocalApp", input),
    getLocalAppStatus: (input) => ipcRenderer.invoke("appFactory:getLocalAppStatus", input),
