...
assert.equal(
  ...
  "1.1.39",
  "the next Desktop patch must include the canonical Workforce ontology alias snapshot",
);
...
assert.equal(runtimeSource.commit, "cf71b8be1732f249b4d79d66246f7d3c0cd0790f", "Agentlas OS v1.1.39 commit drift");
