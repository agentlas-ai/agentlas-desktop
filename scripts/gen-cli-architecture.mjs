...
const data = {
  ...
  localCredentialsMapFile: m.LOCAL_CREDENTIALS_MAP_FILE,
  projectEnvExampleFile: m.PROJECT_ENV_EXAMPLE_FILE,
  projectSigningDir: m.PROJECT_SIGNING_DIR,
  projectCredentialsDir: m.PROJECT_CREDENTIALS_DIR,
  projectCredentialsReadmeFile: m.PROJECT_CREDENTIALS_README_FILE,
  ...
  superOntologyCapabilityDelegationAuthorityFile:
    m.SUPER_ONTOLOGY_CAPABILITY_DELEGATION_AUTHORITY_FILE,
