 ...
 *   node scripts/verify-packaged-updater-install-e2e.cjs \
...
function usage() {
  return [
    "Usage: node scripts/verify-packaged-updater-install-e2e.cjs --platform win32|linux --artifact-dir <Release dir> --target-version <version> [--baseline-ref v0.8.32] [--baseline-version 0.8.32] [--feed-port 0] [--timeout-ms 120000]",
    "       node scripts/verify-packaged-updater-install-e2e.cjs --selftest",
  ].join("\n");
}
